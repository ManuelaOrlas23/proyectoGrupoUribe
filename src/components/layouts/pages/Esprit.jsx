...
import {consumirDatosApiEs} from '../../../services/consumo'
...
const Esprit = () => {
  ...
  useEffect(()=>{
    consumirDatosApiEs().then(function(respuestaDelBack){
...
const handleTAllaSeleccionada = (productoIndex, talla) => {
  ...
  return (
    <div>
      <h2 className="text-center text-4xl bg-sky-100 py-4"> ESPRIT</h2>
