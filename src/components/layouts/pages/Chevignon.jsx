...
import { consumirDatosApiCH } from '../../../services/consumo'
...
const Chevignon = () => {
  ...
  useEffect(() => {
    consumirDatosApiCH().then(function (respuestaDelBack) {
  ...
  if (carga) {
    ...
    return (
      <div>
        <h2 className="text-center text-4xl bg-sky-100 py-4"> CHEVIGNON</h2>
